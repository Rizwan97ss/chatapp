            ...
            <div class="w-full max-w-md rounded-[2rem] bg-white p-6 shadow-2xl ring-1 ring-slate-200 sm:p-8">
                ...
                <div class="mt-8 text-center">
                    ...
                    <p class="mt-3 text-sm leading-6 text-slate-500">
                        Enter your email and create a new secure password for your SchoolPro account.
                    </p>
                </div>
                ...
                <form class="mt-8 space-y-5" @submit.prevent="submit">
                    ...
                    <div>
                        <label for="password_confirmation" class="text-sm font-bold text-slate-700">
                ...
                <p class="mt-8 text-center text-xs font-semibold text-slate-400">
                    SchoolPro · Secure password reset
                </p>
            </div>
        </div>
    </div>
